  ...
  return (
    <section className="relative min-h-[85vh] w-full overflow-hidden bg-neutral-950 text-white">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center px-6 pt-28 text-center sm:pt-36">
        <span className="mb-4 inline-flex items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium text-white/80 backdrop-blur-sm">
          New • AI-powered analytics
        </span>
        <h1 className="text-balance font-extrabold tracking-tight text-white [text-wrap:balance] text-4xl sm:text-5xl md:text-6xl">
