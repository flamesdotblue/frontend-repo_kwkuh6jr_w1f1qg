  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all ${
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className={`rounded-xl border backdrop-blur transition-colors ${
          scrolled
            ? 'border-white/10 bg-neutral-900/60 supports-[backdrop-filter]:bg-neutral-900/40'
            : 'border-white/10 bg-neutral-900/40 supports-[backdrop-filter]:bg-neutral-900/30'
        }`}>
